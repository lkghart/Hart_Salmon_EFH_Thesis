...
if (fit == TRUE){
  ...
  dir.vast <- file.path(here(), "VAST", species, "Mod_2")
  ...
  saveRDS(mod_fit, file.path(dir.work,"chinook_VAST_mod2.rds"))
  ...
  saveRDS(fit0, file.path(dir.work,"chinook_VAST_mod2_null.rds"))
  ...
  mod_fit <- readRDS(file.path(dir.work,"chinook_VAST_mod2.rds"))
  mod_fit_0 <- readRDS(file.path(dir.work, "chinook_VAST_mod2_null.rds"))
}
