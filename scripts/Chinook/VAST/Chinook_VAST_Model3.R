...
if (fit == TRUE){
  ...
  dir.vast <- file.path(here(), "VAST", species, "Mod_3")
  ...
  saveRDS(mod_fit, file.path(dir.work,"chinook_VAST_mod3.rds"))
  ...
  saveRDS(fit0, file.path(dir.work,"chinook_VAST_mod3_null.rds"))
  ...
  mod_fit <- readRDS(file.path(dir.work,"chinook_VAST_mod3.rds"))
  mod_fit_0 <- readRDS(file.path(dir.work, "chinook_VAST_mod3_null.rds"))
}
