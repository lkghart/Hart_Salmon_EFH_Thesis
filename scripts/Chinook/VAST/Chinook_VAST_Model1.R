...
if(fit == TRUE){
  ...
  dir.vast <- file.path(here(), "VAST", species, "Mod_1")
...
# Workflow =====================================================================
  ...
  full_data <- readRDS(file.path(dir.work,"V4_basis_subset.rds"))
  ...
  # Read input grid
  user_region <- readRDS(file.path(dir.work, "user_region2.rds"))
  ...
  saveRDS(mod_fit, file.path(dir.work,"chinook_VAST_mod1.rds"))
  ...
  saveRDS(fit0, file.path(dir.work,"chinook_VAST_mod1_null.rds"))
  ...
  mod_fit <- readRDS(file.path(dir.work,"chinook_VAST_mod1.rds"))
  mod_fit_0 <- readRDS(file.path(dir.work, "chinook_VAST_mod1_null.rds"))
}
