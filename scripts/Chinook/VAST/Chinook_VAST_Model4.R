...
if (fit == TRUE){
  ...
  dir.vast <- file.path(here(), "VAST", species, "Mod_4")
  ...
  saveRDS(mod_fit, file.path(dir.work,"chinook_VAST_mod4.rds"))
  ...
  # make sense
  saveRDS(fit0, file.path(dir.work,"chinook_VAST_mod4_null.rds"))
  ...
  mod_fit <- readRDS(file.path(dir.work,"chinook_VAST_mod4.rds"))
  mod_fit_0 <- readRDS(file.path(dir.work, "chinook_VAST_mod4.rds"))
}
