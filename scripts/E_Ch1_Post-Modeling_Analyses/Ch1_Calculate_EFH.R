...
vast4_CV <- readRDS(file.path(dir.dat, paste0(spec, "_VAST_CV.rds")))
...
for (i in 1:18){
  ...
  vast3b_efh <- rbind(vast3b_efh, df2b)
...
nrow(est3_V) # From 54,,000 prediction points to
nrow(vast3_efh) #24,334 prediction points.
