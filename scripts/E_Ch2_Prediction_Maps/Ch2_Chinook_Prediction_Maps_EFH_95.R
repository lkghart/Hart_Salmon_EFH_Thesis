### Chinook Chapter 2 GAM EFH 95 Maps (response) 
## Author: Lilian Hart 
## Last edited: 06/16/23
...
## Load predictions
# In-situ Model (1A)
in_situ <- readRDS(file.path(dir.work, paste0(spec,"_gam_in-situ_EFH.rds")))
is_CV <- readRDS(file.path(dir.mod, paste0(spec,"_gam_in-situ_link_predictions.rds")))

# Cold Pool Extent SVC models
CPE_low <- readRDS(file.path(dir.work, paste0(spec, "_gam_CPE-low_EFH.rds"))) 
CPE_med <- readRDS(file.path(dir.work, paste0(spec, "_gam_CPE-med_EFH.rds")))
CPE_high <- readRDS(file.path(dir.work, paste0(spec, "_gam_CPE-high_EFH.rds")))
CPE_CV <- readRDS(file.path(dir.mod, paste0(spec, "_gam_CPE-median_link_predictions.rds")))

# Climate stanza predictions
Warm1 <- readRDS(file.path(dir.work, paste0(spec, "_gam_Warm1_EFH.rds")))
Cool <- readRDS(file.path(dir.work, paste0(spec, "_gam_Cool_EFH.rds")))
Warm2 <- readRDS(file.path(dir.work, paste0(spec, "_gam_Warm2_EFH.rds")))
CS_CV <- readRDS(file.path(dir.mod, paste0(spec, "_gam_Warm1_link_predictions.rds")))

# Even/odd year predictions
Even <- readRDS(file.path(dir.work, paste0(spec, "_gam_Even-year_EFH.rds")))
Odd <- readRDS(file.path(dir.work, paste0(spec, "_gam_Odd-year_EFH.rds")))
...
ggplot() +
  ...
  labs(x = "Longitude", y = "Latitude", 
       title = paste("Juvenile",Spec,"salmon In-Situ Model\n Top 95% of Predictions"))

ggsave(paste0(Spec,"_in-situ_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_CPE-low_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_CPE-med_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_CPE-high_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_Warm1_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_Cool_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_Warm2_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_Even_EFH_95.jpeg"), width = 5, height = 5, units = "in")
...
ggsave(paste0(Spec,"_Odd_EFH_95.jpeg"), width = 5, height = 5, units = "in")
