...
if (fit == TRUE){
  ...
  saveRDS(mod_fit, file.path(dir.vast, paste0(spec, "_VAST_mod2.rds")))
  ...
  saveRDS(fit0, file.path(dir.vast,paste0(spec, "_VAST_mod2_null.rds")))
  ...
  mod_fit <- readRDS(file.path(dir.vast, paste0(spec, "_VAST_mod2.rds")))
  mod_fit_0 <- readRDS(file.path(dir.vast, paste0(spec, "_VAST_mod2_null.rds")))
}
